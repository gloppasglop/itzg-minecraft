...
function downloadSpigot {
  ...
  case "$VERSION" in
    latest|LATEST|1.10.2)
       downloadUrl="https://ci.mcadmin.net/job/Spigot/lastSuccessfulBuild/artifact/spigot-1.10.2.jar";;
    1.10)
       downloadUrl="https://ci.mcadmin.net/job/Spigot/73/artifact/spigot-1.10.jar";;
    1.9.4)
       downloadUrl="https://ci.mcadmin.net/job/Spigot/68/artifact/spigot-1.9.4.jar";;
    1.9.2)
       downloadUrl="https://ci.mcadmin.net/job/Spigot/63/artifact/spigot-1.9.2.jar";;
    1.9)
       downloadUrl="https://ci.mcadmin.net/job/Spigot/49/artifact/spigot-1.9.jar";;
    1.8.8)
       downloadUrl="https://ci.mcadmin.net/job/Spigot/17/artifact/spigot-1.8.8.jar";;
    1.8.3)
       downloadUrl="https://ci.mcadmin.net/job/Spigot/5/artifact/spigot-1.8.3.jar";;
    1.8)
       downloadUrl="https://ci.mcadmin.net/job/Spigot/2/artifact/spigot-1.8.jar";;
    *)
       downloadUrl="nosupp";;
  esac

  if [[  "$downloadUrl" != "nosupp" ]]; then
...
mc_exec() {
    if [ -e /tmp/mc-console ]; then
        echo "$@" > /tmp/mc-console
    else
        echo "/tmp/mc-console does not exit"
    fi
}
...
mc_stop() {
   ...
   echo "Could not stop minecraft gracefully. Kill it !!!"
   kill 1
   sleep 10
   kill -SIGKILL 1
}
...
case "$1" in
    ...
    bash)
        ...
        ;;
    *)
        echo "Usage: $0 {start|stop|exec|saveoff|saveon}"
        exit 1
        ;;
esac
